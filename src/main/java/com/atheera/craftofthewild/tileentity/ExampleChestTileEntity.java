package com.atheera.craftofthewild.tileentity;

import javax.annotation.Nonnull;

import com.atheera.craftofthewild.container.ExampleChestContainer;
import com.atheera.craftofthewild.init.ModTileEntityTypes;
...
public class ExampleChestTileEntity extends LockableLootTileEntity {
	...
	@Override public int getSizeInventory() { return 36; }
	
	@Override public NonNullList<ItemStack> getItems() { return this.chestContents; }
	
	@Override protected void setItems(NonNullList<ItemStack> itemsIn) { this.chestContents = itemsIn; }
	
	@Override protected ITextComponent getDefaultName() { return new TranslationTextComponent("container.example_chest"); }
	
	@Override protected Container createMenu(int id, PlayerInventory player) { return new ExampleChestContainer(id, player, this); }
	...
	private void playSound(SoundEvent sound) {
		double dx = (double)this.pos.getX();
		double dy = (double)this.pos.getY();
		double dz = (double)this.pos.getZ();
